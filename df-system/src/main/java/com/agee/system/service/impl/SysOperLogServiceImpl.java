...
import com.agee.system.mapper.SysOperLogMapper;
import com.agee.system.service.SysOperLogService;
...
public class SysOperLogServiceImpl extends ServiceImpl<SysOperLogMapper, SysOperLog> implements SysOperLogService {
    ...
    @Async
    @Override
    public void recordOper(final SysOperLog operLogDTO) {
    ...
    public List<SysOperLog> selectOperLogList(SysOperLog operLog) {
        ...
        return baseMapper.selectList(new LambdaQueryWrapper<SysOperLog>()
                ...
                .between(params.get("beginTime") != null && params.get("endTime") != null, SysOperLog::getOperTime, params.get("beginTime"), params.get("endTime"))
